 ...
 */
public class Caddcomm implements pserver.pservlets.PService {
    ...
    public int service(VectorMap parameters, StringBuffer response, DBAccess dbAccess) {
        ...
        PSparameters.add("com", "addcomm");
        PSparameters.add("name", 
                parameters.getVal(parameters.indexOfKey("name", 0)));
        
        PSparameters.add("users", 
                parameters.getVal(parameters.indexOfKey("users", 0)));
