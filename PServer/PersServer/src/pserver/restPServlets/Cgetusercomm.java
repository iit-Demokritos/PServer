 ...
 */
public class Cgetusercomm implements pserver.pservlets.PService {
    ...
    public int service(VectorMap parameters, StringBuffer response, DBAccess dbAccess) {
        ...
        PSparameters.add("com", "getusercomm");
        PSparameters.add("username", 
                parameters.getVal(parameters.indexOfKey("username", 0)));

        if (parameters.qpIndexOfKeyNoCase("pattern") != -1) {
            PSparameters.add("pattern", 
                    parameters.getVal(parameters.indexOfKey("pattern", 0)));
        }
