 ...
 */
public class Ccalcuftrassoc implements pserver.pservlets.PService {
    ...
    public int service(VectorMap parameters, StringBuffer response, DBAccess dbAccess) {
        ...
        PSparameters.add("com", "calcuftrassoc");
        PSparameters.add("algorithm", 
                parameters.getVal(parameters.indexOfKey("algorithm", 0)));

        if (parameters.qpIndexOfKeyNoCase("properties") != -1) {
            PSparameters.add("properties", 
                    parameters.getVal(parameters.indexOfKey("properties", 0)));
        }
