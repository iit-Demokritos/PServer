 ...
 */
public class Cmakecommunities implements pserver.pservlets.PService {
    ...
    public int service(VectorMap parameters, StringBuffer response, DBAccess dbAccess) {
        ...
        PSparameters.add("com", "makecommunities");
        
        PSparameters.add("algorithm", 
                parameters.getVal(parameters.indexOfKey("algorithm", 0)));
        
        PSparameters.add("association", 
                parameters.getVal(parameters.indexOfKey("association", 0)));

        if (parameters.qpIndexOfKeyNoCase("parameters") != -1) {
            PSparameters.add("parameters", 
                    parameters.getVal(parameters.indexOfKey("parameters", 0)));
        }
