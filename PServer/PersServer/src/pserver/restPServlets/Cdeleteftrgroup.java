 ...
 */
public class Cdeleteftrgroup implements pserver.pservlets.PService {
    ...
    public int service(VectorMap parameters, StringBuffer response, DBAccess dbAccess) {
        ...
        PSparameters.add("com", "deleteftrgroup");
        
        if (parameters.qpIndexOfKeyNoCase("pattern") != -1) {
            PSparameters.add("pattern", parameters.getVal(parameters.indexOfKey("pattern", 0)));
        }
