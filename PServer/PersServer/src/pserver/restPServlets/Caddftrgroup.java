 ...
 */
public class Caddftrgroup implements pserver.pservlets.PService {
    ...
    public int service(VectorMap parameters, StringBuffer response, DBAccess dbAccess) {
        ...
        PSparameters.add("com", "addftrgroup");
        PSparameters.add("name", 
                parameters.getVal(parameters.indexOfKey("name", 0)));
        
        PSparameters.add("features", 
                parameters.getVal(parameters.indexOfKey("features", 0)));
