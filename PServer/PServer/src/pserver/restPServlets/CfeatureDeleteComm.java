 ...
 */
public class CfeatureDeleteComm implements pserver.pservlets.PService {
    ...
    public int service(VectorMap parameters, StringBuffer response, DBAccess dbAccess) {
        ...
        PSparameters.add("com", "rmftrgrp");
        PSparameters.add("grp", parameters.getVal(parameters.indexOfKey("communityname", 0)));
